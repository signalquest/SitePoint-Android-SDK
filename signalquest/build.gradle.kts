...
android {
    ...
    tasks.register<Javadoc>("javadoc") {
        ...
        val sourceSetDirectories = sourceSets["main"]
            .java
            .srcDirs
            .joinToString(":")
        ...
        exclude("com/signalquest/swig")
        exclude("com/signalquest/api/utils")
    }

    afterEvaluate {
        tasks.named<Javadoc>("javadoc") {
            classpath += files(
                android.libraryVariants.flatMap { variant ->
